...
function HomePage() {
  ...
  return (
    <div className=" h-[90vh] bg-[url('https://images.unsplash.com/photo-1517842645767-c639042777db?auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8bm90ZXN8ZW58MHx8MHx8fDA%3D&w=500')] bg-no-repeat bg-cover bg-center bg-[#00000099] bg-blend-overlay">
